var app={
	...
	inicioX: function(){
		return app.numealeatorioHasta(ancho - DIAMENTRO_BOLA);
	},

	inicioY: function(){
		return app. numealeatorioHasta(alto - DIAMENTRO_BOLA);
	},

	numealeatorioHasta: function(limite){
	...
	detectaAgitacion: function(datosAceleracion){
		agitacinX = datosAceleracion.x > 10;
		agitacinY = datosAceleracion.y > 10;

		if(agitacinX || agitacinY){
